...
class TestTestCybertruck():
  ...
  def test_testCybertruck(self):
    ...
    WebDriverWait(self.driver, 5).until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, ".tds-site-nav-items--vertical > li:nth-child(2) .tds-site-nav-item-text")))
    self.driver.find_element(By.CSS_SELECTOR, ".tds-site-nav-items--vertical > li:nth-child(2) .tds-site-nav-item-text").click()
    ...
    self.driver.save_screenshot(f"{self.folderPath}/test-Cybertruck.png")
